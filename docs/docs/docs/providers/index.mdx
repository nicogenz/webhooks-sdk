...
Events), **OpenAI**, and **Standard Webhooks** — the last of which covers
every Svix-backed vendor, with named wrappers for **Resend**, **Clerk**,
**Polar**, and **Replicate**.
...
<CardGroup cols={2}>
  ...
  <Card title="Standard Webhooks" href="/docs/providers/standard-webhooks" icon="webhook">
    Resend, Clerk, Polar, Replicate, Svix — one spec.
  </Card>
</CardGroup>
