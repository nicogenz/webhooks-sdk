...
**Dodo Payments**, **Replicate**, and **Standard Webhooks** — the last of
which covers every other Svix-backed vendor.
...
<CardGroup cols={2}>
  ...
  <Card title="Dodo Payments" href="/docs/providers/dodo-payments" icon="dodo-payments">
