...
description: One spec, dozens of vendors — Resend, Clerk, Polar, Replicate, OpenAI ship as wrappers; everything else works generically.
---
...
Five vendors ship as typed one-line wrappers:
...
That covers Loops, Dodo Payments, Stytch, and Svix itself — and any
